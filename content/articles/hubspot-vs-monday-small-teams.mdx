...
<ComparisonTable
  ...
  toolB="Monday.com"
  features={[
    { name: "Primary Use Case", toolA: "CRM / Sales & Marketing", toolB: "Project & Work Management" },
    { name: "Free Plan", toolA: true, toolB: true },
    { name: "Contact Management", toolA: true, toolB: false },
    { name: "Deal Pipeline", toolA: true, toolB: "Limited" },
    { name: "Email Marketing", toolA: true, toolB: false },
    { name: "Project Boards", toolA: "Limited", toolB: true },
    { name: "Gantt Charts", toolA: false, toolB: true },
    { name: "Automations", toolA: true, toolB: true },
    { name: "Time Tracking", toolA: false, toolB: true },
    { name: "Starting Price (paid)", toolA: "$15/user/mo", toolB: "$9/user/mo" },
    { name: "Native Integrations", toolA: "1,000+", toolB: "200+" },
  ]}
/>
